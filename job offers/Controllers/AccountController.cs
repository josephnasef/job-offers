...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ViewBag.UserType = 
                    new SelectList(db.Roles.Where(a => !a.Name.Contains("admin")).ToList(), "Name", "Name");
        ...
        public ViewResult Editprofile(EditProfileViewModel profile)
        {
            ...
            {
                ViewBag.Message = "Your Password is Wrong please try Agin";
            }
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "Your Edits to your profile have been successfully completed";
